...
// from: http://www.kevs3d.co.uk/dev/warpfield/
...
// get dimensions of window and resize the canvas to fit
    var width = 800,//window.innerWidth,
        ...
        canvas = document.getElementById("futureStarfield"),
...
// star rendering anim function
    var rf = function () {
        ...
        // draw text
        G.font = "bold 48px PT serif";
        G.fillStyle = "#FFF";
        G.fillText("welcome to the future.", 120, 300);
